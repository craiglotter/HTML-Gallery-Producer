...
Public Class Main_Screen
                    ...
                    For Each finfo As FileInfo In dinfo.GetFiles()
                        ...
                        Try
                            ...
                            If Array.IndexOf(acceptable, finfo.Extension.ToLower) <> -1 Then
                                ...
                                Dim savename As String = finfo.FullName.Remove(finfo.FullName.Length - finfo.Extension.Length) + "_gthumb.jpg"
                                Try
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.Text = "HTML Gallery Producer " & My.Application.Info.Version.Major & My.Application.Info.Version.Minor & My.Application.Info.Version.Build & "." & My.Application.Info.Version.Revision
